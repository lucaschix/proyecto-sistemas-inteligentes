...
`proyect.js` carga estos recursos bajo demanda y entrega a `mount(root, context)` las utilidades compartidas:
...
Los estilos comunes, tokens y navegación permanecen en `style.css`. Los selectores propios de una slide deben
